...
class UserController extends Controller
{
    ...
    $data = User::all();
    return view('admin.customers.main',compact('data'));
}
...
function destroy($id)
{
    ...
    $data = User::find($id);
    if($data->delete()){
        return redirect('/admin/customers')->with('status', 'User was deleted successfully');
    }
    else return redirect('/admin/customers')->with('status', 'There was an error');
